...
UUID=${UUID:-'6066e694-9768-44da-8e25-bd63e61f90fe'}
VMESS_WSPATH=${VMESS_WSPATH:-'/ZC2CkpnKBfD'}
VLESS_WSPATH=${VLESS_WSPATH:-'/pkBvGAugnA'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/8U2bgB67iJoLl'}
SS_WSPATH=${SS_WSPATH:-'/HVPwn2Fb7Dh'}
